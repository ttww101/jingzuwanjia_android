...
import com.ccaaii.shenghuotong.Loader.GlideImageLoader;
...
public class HomeFragmentActivity extends FragmentActivity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("testtest", "onCreate:  " + height);
...
//		DocumentUtils.testParseData(this);
	...
	private void buildLayout() {
		...
		empty_view = (RelativeLayout) this.findViewById(R.id.empty_view);
		...
		mButtonHome.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				wb.loadUrl("https://m.ydniu.com/info/jczq/");
		...
		mButtonDiscovery.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				wb.setVisibility(View.VISIBLE);
				wb.loadUrl("https://www.qtx.com/soccer?fbclid=IwAR1QHcdBP4KAUBZEKTXC_MA1_Oo68KFTOh10IQN2yL6CS-50q51Kc7NNyWA");
				wb.setWebViewClient(new WebViewClient()
				{
					public void onPageFinished(WebView paramAnonymousWebView, String paramAnonymousString)
					{
		...
		mButtonSetting.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				wb.setVisibility(View.VISIBLE);
				wb.loadUrl("https://www.qtx.com/dbsoccer");
				wb.setWebViewClient(new WebViewClient()
				{
					public void onPageFinished(WebView paramAnonymousWebView, String paramAnonymousString)
					{
	...
	private void init()
	{
		RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(MATCH_PARENT, (int)(height * 0.2375));
		...
		for (;;)
		{
			...
			this.wb.loadUrl("https://m.ydniu.com/info/jczq/");
	...
	private void initBanner(){
		...
		imagePath.add(R.drawable.banner_img1);
		imagePath.add(R.drawable.banner_img2);
		imagePath.add(R.drawable.banner_img3);
		banner = (Banner) findViewById(R.id.banner);
		//设置图片集合
		//设置图片加载器
		banner.setImageLoader(mGlideImageLoader);
